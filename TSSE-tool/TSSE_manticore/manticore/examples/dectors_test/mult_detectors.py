...
def d_execute(filename,contractname,function_Name):
    ...
    m.multi_tx_analysis1(initcode, contract_name=contractname, args=symbolic_value,tx_limit=1,tx_preconstrain=False,tx_use_coverage=True,tx_send_ether=True)
...
# python mult_detectors.py ethereum/contracts/detectors/overflow2.sol Overflow "add(uint256)"
